...
|---|---|---|---:|---|---|---|
| `logo` | `assets/logo.png` | Header and footer on all primary pages | Brand name only | LANGUAGE-NEUTRAL | Shared / 1 | Cogna Bright is a protected, untranslated brand name. |
